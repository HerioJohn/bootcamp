...
public class JavaQuest10_Submission {

  public static void main(String[] args) {

    int[] my_array = { 25, 14, 56, 15, 36, 56, 77, 18, 29, 49 };

    //    int[] my_array = { 25, 14, 56, 200, 15, 56, 77, 18, 29, 49 };
    ...
    for (int i = 0; i < my_array.length - indexPosition - 1; i++) {

      newValue = my_array[indexPosition + i + 1];
      my_array[indexPosition + i + 1] = temp; 
      temp = newValue;                        
